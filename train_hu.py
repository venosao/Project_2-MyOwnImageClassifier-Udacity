...
class NeuralNetwork(nn.Module):
    ...
    def __init__(self, inputs, output, hidden_units, drop):
        
        # calls init method of nn.Module (base class)
        super().__init__()
        
        # input_size to hidden_units 1 : ModuleList --> list meant to store nn.Modules
        self.hidden_units = nn.ModuleList([nn.Linear(inputs, hidden_units[0])])
...
def main():
    ...
    hidden_units = args.hidden_units #added for hidden units user def
