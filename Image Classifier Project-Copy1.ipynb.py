...
image_datasets = [datasets.ImageFolder(train_dir, transform=training_transforms), datasets.ImageFolder(valid_dir, transform=validataion_transforms),
...
print("\nTime spent training: {:.0f}m {:.0f}s".format(time_spent//60, time_spent % 60))
...
def load_checkpoint(filepath):
    ...
    model = getattr(torchvision.models, checkpoints['arch'])(pretrained=True)
    model.classifier = checkpoint['classifier']
    learning_rate = checkpoint['learning_rate']
    model.epochs = checkpoint['epochs']
    model.optimizer = checkpoint['optimizer']
    model.lstate_dict = checkpoint['state_dict']
    model.class_to_indx = checkpoint['class_to_indx']
...
# Sanity check
image_path = 'flowers/test/7/image_08099.jpg'
...
# <imgsrc='assets/inference_example.png'width=300px>
...
path = 'flowers/test/7/image_08099.jpg'
